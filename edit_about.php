...
600">Beranda</a></li><li><a href="data_artikel.php" class="block hover:text-blue-
...
<input type="hidden" name="id_about" value="<?php echo
$data['id_about']; ?>">
<div>
...
focus:border-blue-500"><?php echo htmlspecialchars($data['about']);
?></textarea>
</div>
